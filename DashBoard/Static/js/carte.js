...
const StylePolygon = new ol.style.Style({
    image: new ol.style.Circle({
        radius: 7,
        fill: new ol.style.Fill({ color: [50, 205, 50, 1] }),
        ...
        for (let zag of Object.values(aaqsa)) {
            ...
            for (let station of Object.entries(zag["stations"])) {
                try {
                    ...
                    let feature = new ol.Feature({
                        geometry: new ol.geom.Point(ol.proj.transform([station[1]["Lon"], station[1]["Lat"]], 'EPSG:4326', 'EPSG:3857')),
            ...
            for (let polygon of Object.values(zag["Polygon"])) {
                ...
                for (let i = 0; i < coordsArray.length; i++) {
                    coordsArray[i] = ol.proj.transform([parseFloat(coordsArray[i][2]), parseFloat(coordsArray[i][1])], 'EPSG:4326', 'EPSG:3857');
                }
